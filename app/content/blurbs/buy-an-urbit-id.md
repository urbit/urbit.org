...
imageDark = ""
references = [
    { title = "OpenSea", link = "https://opensea.io/collection/urbit-id", description = "An NFT Marketplace that supports trading Layer 1 Urbit IDs" },
    { title = "subject.network", link = "https://subject.network/buy/", description = "Buy a Layer 2 planet with bitcoin" },
    { title = "~pocwet", link = "https://store.pocwet.com/", description = "Buy a Layer 2 planet with a credit card" },
]
[call-to-action]
label = ""
link = ""
