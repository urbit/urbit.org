...
distribution:
  ...
  source: "repo build"
  desk: "%mcp"
  install_command: "|install our %mcp"
  notes: "Build the desk and copy it into a mounted %mcp desk before committing and installing."
github_repo: "https://github.com/gwbtc/urbit-mcp"
tlon_group:
  id: "~hodler-lorfeb/v769287"
  url: null
related_references: []
dependencies: []
---
