...
source_kind: "blog"
canonical_url: "/blog/contributor-spotlight-dozreg-toplud"
human_md_url: "/blog/contributor-spotlight-dozreg-toplud.md"
agent_mode: "fallback"
dependencies: []
related_pages:
  - "/blog.md"
...
Human-oriented content: /blog/contributor-spotlight-dozreg-toplud.md
...
And when I got familiar with Urbit, what was really interesting for me is, for a lack of a better word, the shallowness of the software stack. On the low level you have Nock as a sort of functional instruction set architecture, and a very simple one. You have a self-hosted language, which is currently the biggest part of the stack in terms of complexity and line count. Then you have the Arvo state machine and the kernel modules that it drives, and that’s basically it. It’s not that much code. When I write a userspace program, like a Gall agent, I feel like I am still very close to the core of the computation, and I find this very satisfying.
