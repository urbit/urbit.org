...
canonical_url: "/overview/urbit-explained"
human_md_url: "/overview/urbit-explained.md"
agent_mode: "fallback"
dependencies:
  - "/overview/urbit-explained/urbit-id.md"
  - "/overview/urbit-explained/urbit-os.md"
related_pages:
  - "/overview.md"
  - "/overview/urbit-explained.md"
  - "/overview/urbit-explained/urbit-id.md"
  - "/overview/urbit-explained/urbit-os.md"
---

Human-oriented content: /overview/urbit-explained.md
...
- [Urbit ID](/overview/urbit-explained/urbit-id.md) — A decentralized identity system for the Urbit network
- [Urbit OS](/overview/urbit-explained/urbit-os.md) — A new operating system designed to give individuals control of their digital lives
- [Beyond](/overview/urbit-explained/beyond.md) — Building towards a decentralized future for a distributed network
