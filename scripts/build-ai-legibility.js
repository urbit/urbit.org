...
const buildAgentsMd = (canonicalBase) => [
  ...
  `- ${canonicalBase}/.agents/skills/running-urbit-os/SKILL.md`,
  `- ${canonicalBase}/.agents/skills/running-urbit-os/references/comet-onboarding-for-agents.md`,
  `- ${canonicalBase}/.agents/skills/bundles/userspace-apps.yaml`,
  "",
  "## Retrieval notes",
