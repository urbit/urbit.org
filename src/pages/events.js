    ...
    <Container>
      ...
      <Main className="text-primary overflow-x-hidden" singleColumn>
        <section>
          ...
          <p className="h1">
            Explore Urbit and meet our community.
          </p>
        </section>
        ...
        <Section divider={"border-primary"}>
            ...
            <p className="h2">
             In addition to in-person, we regularly hold online events where you can hang out, learn, and get involved. Most of these are in the Urbit Hacker House, a shared virtual office space.
              </p>
            </section>
            <Link
            style={{ marginRight: '12px' }}
            className="btn bg-primary hover:bg-secondary text-surface body-lg w-min"
            href="https://calendar.google.com/calendar/ical/c_3699bf76be682b9093ba236290972bc80311ba46756914c3b63151d7528bbc6e%40group.calendar.google.com/public/basic.ics"
            >
            ...
            <iframe 
            src="https://calendar.google.com/calendar/embed?height=600&wkst=1&ctz=America%2FNew_York&bgcolor=%23ffffff&showPrint=0&showTitle=0&showTabs=0&showCalendars=0&showDate=1&src=c_3699bf76be682b9093ba236290972bc80311ba46756914c3b63151d7528bbc6e@group.calendar.google.com&color=%23D81B60" 
